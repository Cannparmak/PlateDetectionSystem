...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "rev_today":          {"tr": "Bugünkü Hasılat",               "en": "Today's Revenue"},
    "rev_month":          {"tr": "Bu Ay",                         "en": "This Month"},
    "rev_year":           {"tr": "Bu Yıl",                        "en": "This Year"},
    "rev_park":           {"tr": "Park Ücretleri",                "en": "Parking Fees"},
    "rev_sub":            {"tr": "Abonelik Gelirleri",            "en": "Subscription Revenue"},
    "rev_total":          {"tr": "Toplam Hasılat",                "en": "Total Revenue"},
    "rev_breakdown":      {"tr": "Gelir Dağılımı",                "en": "Revenue Breakdown"},
    "rev_30day":          {"tr": "Son 30 Gün Hasılatı",           "en": "Last 30 Days Revenue"},
    "rev_cash":           {"tr": "Nakit",                         "en": "Cash"},
    "rev_card":           {"tr": "Kredi Kartı",                   "en": "Credit Card"},
    # ── Common buttons ────────────────────────────────────────────────
